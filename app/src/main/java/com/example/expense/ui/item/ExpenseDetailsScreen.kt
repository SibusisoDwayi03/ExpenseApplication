...
object ItemDetailsDestination : ExpenseDestination {
...
fun ItemDetails(
    ...
    Card(
        ...
        Column(
            ...
            ItemDetailsRow(
                labelResID = R.string.expense_name_req,
            ...
            ItemDetailsRow(
                ...
                itemDetail = item.category.toString(),
                modifier = Modifier.padding(
                    horizontal = dimensionResource(
                        id = R.dimen
                            .padding_medium
            ...
            ItemDetailsRow(
                labelResID = R.string.expense_description_req,
            ...
            ItemDetailsRow(
                labelResID = R.string.expense_date_req,
